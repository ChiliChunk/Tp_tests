...
public class JaugeNegatifTest {
	...
	private JaugeNegatif j1 , j2 , j3 , j4 , j5 , j6 , j7 , j8 , j9 , j10;
	
	@Before
	public void setUp() throws Exception {
		j1 = new JaugeNegatif(10, 100, 11); //verte
		j2 = new JaugeNegatif(50, 100, 35); // bleu
		j3 = new JaugeNegatif(0, 50, 60); // rouge
		j4 = new JaugeNegatif (0,50,0); // departe == min
		j5 = new JaugeNegatif(10, 50, 8); // depart < min
		j6 = new JaugeNegatif(50, 40, 45); // max<depart<min
		j7 = new JaugeNegatif(50, 50, 50); // max = min = depart
		j8 = new JaugeNegatif(50, 50, 80); // max = min < depart
		j9 = new JaugeNegatif(10, 40, 50); // min < max < depart
		j10 = new JaugeNegatif(10, 50, 50); // min < max = depart
	}
...
//		
	...
	@Test
	 public void testDeplacement ( ) {
		j1.decrementer();
		assert j1.estVert() == false : "1La jauge doit etre bleu";
		assert j1.estRouge() == false : "2La jauge doit etre bleu";
		assert j1.estBleu()== true : "3La jauge doit etre bleu";
	
		j1.incrementer();
		assert j1.estVert() == true : "4La jauge doit etre verte";
		assert j1.estRouge() == false : "5La jauge doit etre verte";
		assert j1.estBleu()== false : "6La jauge doit etre verte";
